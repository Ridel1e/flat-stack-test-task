	...
	var widget = function widget(sandbox) {
	  ...
	  function init() {
	    ...
	    sandbox.addEventListener(button, 'click', function () {
	      var newElement = sandbox.createElement('<p>New Record</p>');

	      sandbox.addEventListener(newElement, 'click', function () {
	        sandbox.removeElement(newElement);
	      });
